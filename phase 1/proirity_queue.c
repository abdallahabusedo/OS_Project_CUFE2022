#include<stdio.h>
#define N 20
struct Process* Q[N]; int Pr[N];
int r = -1,f = -1;
// struct Process** getHPF_Q(Process** processes, int count){

// }
void HPF_enqueue(struct Process* data,int p)//Enqueue function to insert data and its priority in queue
{
	int i;
